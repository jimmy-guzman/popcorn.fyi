...
export type SchemaDescriptions = components['schemas']['Descriptions'];
export type SchemaAliases = components['schemas']['Aliases'];
export type SchemaSitelink = components['schemas']['Sitelink'];
export type SchemaStatement = components['schemas']['Statement'];
export type ResponseItemRedirected = components['responses']['ItemRedirected'];
export type ResponseDataPolicyViolation = components['responses']['DataPolicyViolation'];
export type ResponsePermissionDenied = components['responses']['PermissionDenied'];
export type ResponseRequestLimitReached = components['responses']['RequestLimitReached'];
export type ResponseResourceNotFound = components['responses']['ResourceNotFound'];
export type ResponseInvalidEntityIdInput = components['responses']['InvalidEntityIdInput'];
export type ResponseInvalidRetrieveStatementsInput = components['responses']['InvalidRetrieveStatementsInput'];
export type ResponseInvalidNewStatementInput = components['responses']['InvalidNewStatementInput'];
export type ResponseInvalidSetLabelInput = components['responses']['InvalidSetLabelInput'];
export type ResponseInvalidSetDescriptionInput = components['responses']['InvalidSetDescriptionInput'];
export type ResponseInvalidRemoveLabelInput = components['responses']['InvalidRemoveLabelInput'];
export type ResponseInvalidRemoveDescriptionInput = components['responses']['InvalidRemoveDescriptionInput'];
export type ResponseInvalidAddAliasesInput = components['responses']['InvalidAddAliasesInput'];
export type ResponseInvalidTermByLanguageInput = components['responses']['InvalidTermByLanguageInput'];
export type ResponseInvalidPatch = components['responses']['InvalidPatch'];
export type ResponseCannotApplyItemPatch = components['responses']['CannotApplyItemPatch'];
export type ResponseCannotApplyPropertyPatch = components['responses']['CannotApplyPropertyPatch'];
export type ResponseInvalidPatchedItem = components['responses']['InvalidPatchedItem'];
export type ResponseInvalidPatchedProperty = components['responses']['InvalidPatchedProperty'];
export type ResponseInvalidPatchedLabels = components['responses']['InvalidPatchedLabels'];
export type ResponseInvalidPatchedDescriptions = components['responses']['InvalidPatchedDescriptions'];
export type ResponseInvalidPatchedAliases = components['responses']['InvalidPatchedAliases'];
export type ResponseCannotApplyStatementPatch = components['responses']['CannotApplyStatementPatch'];
export type ResponseInvalidPatchedStatement = components['responses']['InvalidPatchedStatement'];
export type ResponsePreconditionFailedError = components['responses']['PreconditionFailedError'];
export type ResponseUnexpectedError = components['responses']['UnexpectedError'];
export type ResponseItem = components['responses']['Item'];
export type ResponseSitelinks = components['responses']['Sitelinks'];
export type ResponseSitelink = components['responses']['Sitelink'];
export type ResponseProperty = components['responses']['Property'];
export type ResponseNotModified = components['responses']['NotModified'];
export type ResponseMovedPermanently = components['responses']['MovedPermanently'];
...
export type ParameterItemStatementId = components['parameters']['ItemStatementId'];
export type ParameterPropertyStatementId = components['parameters']['PropertyStatementId'];
export type ParameterLanguageCode = components['parameters']['LanguageCode'];
export type ParameterSiteId = components['parameters']['SiteId'];
export type ParameterItemFields = components['parameters']['ItemFields'];
export type ParameterPropertyFields = components['parameters']['PropertyFields'];
export type ParameterPropertyFilter = components['parameters']['PropertyFilter'];
export type ParameterIfNoneMatch = components['parameters']['IfNoneMatch'];
export type ParameterIfModifiedSince = components['parameters']['IfModifiedSince'];
export type ParameterIfMatch = components['parameters']['IfMatch'];
export type ParameterIfUnmodifiedSince = components['parameters']['IfUnmodifiedSince'];
export type ParameterAuthorization = components['parameters']['Authorization'];
export type ParameterSearchLanguage = components['parameters']['SearchLanguage'];
export type ParameterLimit = components['parameters']['Limit'];
export type ParameterOffset = components['parameters']['Offset'];
export type RequestBodyDelete = components['requestBodies']['Delete'];
export type HeaderContentLanguage = components['headers']['Content-Language'];
export type HeaderETag = components['headers']['ETag'];
export type HeaderLastModified = components['headers']['Last-Modified'];
export type HeaderLocation = components['headers']['Location'];
export type HeaderXAuthenticatedUser = components['headers']['X-Authenticated-User'];
